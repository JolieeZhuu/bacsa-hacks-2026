...
# checks how similar the DNA strings are
# Needleman-Wunsch algorithm --> implementation of edit distance
# Edit distance (minimum cost of replacing/adding/deleting letters)
...
def seq_align(seq1, seq2):
    ...
    # start at bottom right cell (and work backwards) --> and find the max value adjacent to the cell
    # upper cell -> alignment gap in sequence 1
    # etc.
    i = lenSeq1
    j = lenSeq2
    while i != 0 and j != 0:
